...
namespace RemoteTech
{
    public class Target : IPersistenceLoad, IEnumerable<ISatellite>, IEquatable<Target>
    {
        ...
        public IEnumerable<ISatellite> GetTargets()
        {
            switch (Type)
            {
                ...
                case TargetType.Planet:
                    var planet = RTCore.Instance.Network.Planets[guid];
                    if (planet != null) yield return planet.AsSatellite();
                    yield break;
                case TargetType.ActiveVessel:
                    var act = RTCore.Instance.Satellites[RTUtil.GetActiveVessel()];
        ...
        public bool Includes(CelestialBody cb) {
        ...
        public static Target Planet(CelestialBody cb)
        {
